...
//* 描述：造成{Damage:diff()}点伤害。 获得{Power:diff()}层红温值。
//*******************************************************
...
public sealed class AngryStrike : CardBaseModel
{
    ...
    public AngryStrike() : base(energyCost, type, rarity, targetType, shouldShowInCardLibrary) { }
